        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-2">
                @if($exam->questions->count() > 0)
                    <a href="{{ route('admin.exams.questions.create', $exam->id) }}" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700">
                        Add More Questions
                    </a>
                @else
            ...
            <div class="flex justify-between">
                ...
                <div class="flex space-x-2">
                    ...
                    <form action="{{ route('admin.exams.destroy', $exam->id) }}" method="POST" class="inline">
                        @csrf
                        @method('DELETE')
                        <button type="submit" onclick="return confirm('Are you sure you want to delete this exam? This will also delete all questions and attempts.')"
