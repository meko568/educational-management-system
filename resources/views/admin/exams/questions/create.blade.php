                ...
                <div class="w-64 flex-shrink-0">
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg sticky top-4">
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 p-4">
                            ...
                            <a href="{{ route('admin.exams.index') }}" class="w-full inline-flex items-center justify-center px-4 py-2 bg-gray-600 dark:bg-gray-700 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 dark:hover:bg-gray-600">
                                Cancel
                            </a>
                        </div>
                    </div>
