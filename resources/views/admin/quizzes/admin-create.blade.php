<x-app-layout>
    <div style="display: flex; flex-direction: column; gap: 2rem; max-width: 48rem; margin: 0 auto;">
        ...
        <div style="display: flex; flex-direction: column; gap: 1rem; justify-content: space-between; align-items: flex-start;" class="md:flex-row md:items-center">
            <div>
                <h1 style="font-size: 1.5rem; font-weight: 700; color: var(--text-main); margin: 0;">Create Auto-Revision Quiz</h1>
                <p style="color: var(--text-muted); margin-top: 0.25rem; font-size: 0.875rem;">Fast assessment for <span style="font-weight: 700; color: var(--accent-color);">{{ strtoupper($selectedGrade) }}</span></p>
            </div>
        ...
        <div class="card-custom">
            <form method="POST" action="{{ route('admin.quizzes.store', ['grade' => $selectedGrade]) }}" style="display: flex; flex-direction: column; gap: 2rem;">
                @csrf
                ...
                <div style="display: flex; flex-direction: column; gap: 1rem;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                        ...
                        <div>
                            <span style="font-size: 0.625rem; font-weight: 900; color: var(--text-muted); text-transform: uppercase;">Expiry Time (End of Day):</span>
                ...
                <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                    ...
                    <input id="duration_minutes" name="duration_minutes" type="number" value="{{ old('duration_minutes', 30) }}" min="1" required
                           style="width: 100%; padding: 0.75rem 1rem; background-color: var(--bg-alt); border: 1px solid var(--border-color); border-radius: 0.75rem; color: var(--text-main); font-size: 0.875rem;">
    ...
    <script>
        ...
        function updateDates(baseDate) {
            ...
            // Calculate end: base date + 23:59:59
