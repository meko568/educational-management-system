<x-app-layout>
                ...
                <div class="flex-1">
                    <div class="bg-white dark:bg-stone-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <form id="quiz-form" method="POST" action="{{ route('admin.quizzes.questions.store', $quiz->id) }}" enctype="multipart/form-data">
                                @csrf
    ...
    <script>
        ...
        const STORAGE_KEY = `admin_quiz_persist_{{ $quiz->id }}`;
