                    ...
                    <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded-lg">
                        <div class="grid grid-cols-2 gap-4 text-sm">
                            <div>
                                ...
                                <span class="text-blue-700 dark:text-blue-300 ml-2">{{ $quiz->grade }}</span>
                            </div>
                            <div>
                                <span class="font-semibold text-blue-800 dark:text-blue-200">Duration:</span>
                                <span class="text-blue-700 dark:text-blue-300 ml-2">{{ $quiz->duration_minutes }} minutes</span>
                            </div>
                            <div>
                                <span class="font-semibold text-blue-800 dark:text-blue-200">Start:</span>
                                <span class="text-blue-700 dark:text-blue-300 ml-2">{{ $quiz->start_datetime->format('M d, Y - H:i') }}</span>
                            </div>
                            <div>
                                <span class="font-semibold text-blue-800 dark:text-blue-200">End:</span>
                                <span class="text-blue-700 dark:text-blue-300 ml-2">{{ $quiz->end_datetime->format('M d, Y - H:i') }}</span>
                            </div>
                        </div>
                    </div>
