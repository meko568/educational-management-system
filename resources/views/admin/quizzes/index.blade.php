                            ...
                            <tr style="border-bottom: 1px solid var(--border-color); transition: background-color 0.2s;">
                                ...
                                <td style="padding: 1.25rem 1.5rem; text-align: {{ app()->getLocale() === 'ar' ? 'left' : 'right' }};">
                                    <div style="display: flex; align-items: center; justify-content: flex-end; gap: 0.5rem;">
                                        <a href="{{ route('admin.manual-quizzes.show', $quiz->id) }}" style="display: flex; align-items: center; gap: 0.375rem; padding: 0.4rem 0.75rem; background-color: rgba(79, 70, 229, 0.1); color: #b5501f; border-radius: 0.5rem; text-decoration: none; font-size: 0.75rem; font-weight: 700;">
