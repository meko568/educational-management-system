            ...
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Code: {{ $course->code }}</p>
                ...
                <div class="mt-8">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">Lessons ({{ count($lessons) }})</h3>

                    @if($lessons->isEmpty())
                        <p class="text-gray-500 text-center py-8">No lessons yet. Create one to get started!</p>
                    @else
                        <div class="space-y-4">
                                ...
                                <div class="border border-gray-200 rounded-lg p-4">
                                    <div class="flex justify-between items-start">
                                        ...
                                        <div class="flex gap-2">
                                            ...
                                            <form method="POST" action="{{ route('admin.courses.lessons.destroy', [$academicYear, $course, $lesson]) }}" style="display:inline;" onsubmit="return confirm('Are you sure?');">
                                                @csrf
                                                @method('DELETE')
