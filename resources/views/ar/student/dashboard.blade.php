        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">أداء الاختبارات</h3>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">أداء الكويز</h3>
                        <div class="chart-container" style="position: relative; height:300px;">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center" style="flex-direction: row-reverse;">
                        <div>
                            <h3 class="text-lg font-medium text-gray-900">مرحباً، {{ $student->name }}</h3>
                            <p class="text-gray-600">كود الطالب: {{ $student->code }}</p>
                            <p class="text-gray-600">الصف الدراسي: {{ $student->academicYear ?? 'غير متاح' }}</p>
                            @if($student->phone)
                                <p class="text-gray-600">رقم الهاتف: {{ $student->phone }}</p>
                            @endif
                            @if($student->parent_phone)
                                <p class="text-gray-600">هاتف ولي الأمر: {{ $student->parent_phone }}</p>
                            @endif
                        </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-medium text-gray-900">الاختبارات</h3>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-medium text-gray-900">الكويز</h3>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <h3 class="text-lg font-medium text-gray-900">الحضور</h3>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <h3 class="text-lg font-medium text-gray-900">الدورات</h3>
                                    <p class="text-2xl font-semibold text-gray-700">إدارة الدروس</p>
                                </div>
                            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">أحدث نتائج الاختبارات</h3>
                        ...
                        @else
                            <p class="text-gray-500">لا توجد نتائج اختبارات.</p>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">آخر الحضور</h3>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">جميع نتائج الاختبارات القصيرة</h3>
                    @if(count($quizResults) > 0)
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">الكويز</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">التاريخ</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">الدرجة</th>
                                    </tr>
                                </thead>
                    ...
                    @else
                        <p class="text-gray-500">لا توجد نتائج اختبارات قصيرة.</p>
                    @endif
                </div>
            </div>
        </div>
