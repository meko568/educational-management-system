            ...
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <div class="grid grid-cols-2 gap-6 mb-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-900 font-semibold">{{ $quiz->title }}</p>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Max Score</label>
                        <p class="mt-2 text-sm text-gray-900 font-semibold">{{ $quiz->total_marks }}</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-sm text-gray-900">{{ $quiz->exam->title ?? 'N/A' }}</p>
                    </div>
                    @if($quiz->description)
                        <div class="col-span-2">
                            <label class="block text-sm font-medium text-gray-700">Description</label>
                            <p class="mt-2 text-sm text-gray-900">{{ $quiz->description }}</p>
                        </div>
                    @endif
                </div>
