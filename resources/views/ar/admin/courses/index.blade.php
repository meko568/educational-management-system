        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-semibold text-gray-800">إدارة الدورات</h2>
                ...
                @if($courses->isEmpty())
                    <p class="text-gray-500 text-center py-8">لا توجد دورات. أنشئ دورة للبدء!</p>
                @else
                        ...
                        <table class="min-w-full">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">الدروس</th>
                                ...
                                @foreach($courses as $course)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm space-x-2">
                                            ...
                                            <form method="POST" action="{{ route('admin.courses.destroy', [$academicYear, $course]) }}" style="display:inline;" onsubmit="return confirm('هل أنت متأكد؟');">
                                                @csrf
                                                @method('DELETE')
