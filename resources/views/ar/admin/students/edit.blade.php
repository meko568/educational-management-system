    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                <h2 class="text-2xl font-semibold text-gray-800 mb-6">تعديل الطالب</h2>
                ...
                <form method="POST" action="{{ route('admin.students.update', $student->code) }}">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700">كود الطالب</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700">رقم هاتف وليّ الأمر</label>
