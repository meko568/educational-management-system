    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                @if(session('success'))
                    <div class="bg-green-100 border-r-4 border-green-500 text-green-700 p-4 mb-6" role="alert" style="direction: rtl;">
                        <div class="flex">
                            <div class="py-1">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                                        لا توجد اختبارات. <a href="{{ route('admin.exams.create') }}" class="text-indigo-600 hover:text-indigo-900">إنشاء اختبار جديد</a>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
