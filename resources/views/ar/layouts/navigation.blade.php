            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <button type="button" onclick="window.location.href='{{ route('lang.switch', ['locale' => 'ar']) }}'" class="w-full text-left block px-4 py-2 text-sm leading-5 text-gray-500 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-700 transition duration-150 ease-in-out">
                            {{ __('messages.arabic') }}
                        </button>

                        <div class="px-4 py-2 text-xs text-gray-500 dark:text-gray-300">{{ __('messages.theme') }}</div>
                        <button type="button" onclick="window.setTheme('light')" class="w-full text-left block px-4 py-2 text-sm leading-5 text-gray-500 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-700 transition duration-150 ease-in-out">
                            {{ __('messages.theme_light') }}
                        </button>
                        <button type="button" onclick="window.setTheme('dark')" class="w-full text-left block px-4 py-2 text-sm leading-5 text-gray-500 dark:text-gray-100 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-700 transition duration-150 ease-in-out">
