    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-gray-600">الصف الدراسي: {{ $academicYear ?? 'غير متاح' }}</p>
                            @if($student->phone)
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-medium text-gray-900 mb-4">آخر الحضور (التاريخ والوقت بالكامل)</h3>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">جميع نتائج الكويز</h3>
                    ...
                    @else
                        <p class="text-gray-500">لا توجد نتائج كويز.</p>
                    @endif
                </div>
            </div>
        </div>
