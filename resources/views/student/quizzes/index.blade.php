    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if($availableQuizzes->count() > 0)
                <div class="mb-8">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Available Quizzes</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        @foreach($availableQuizzes as $quiz)
                            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                <div class="p-6">
                                    <h4 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">{{ $quiz->title }}</h4>
                                    @if($quiz->description)
            ...
            @else
                <div class="mb-8 p-6 bg-gray-50 dark:bg-gray-700 rounded-lg text-center">
                    <p class="text-gray-600 dark:text-gray-400">No available quizzes at the moment.</p>
                </div>
            @endif
            ...
            @if($completedQuizzes->count() > 0)
                <div>
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4">Completed Quizzes</h3>
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                                        ...
                                        @foreach($quiz->attempts as $attempt)
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <a href="{{ route('student.quizzes.result', $attempt->id) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">
                                                        View Result
                                                    </a>
                                                </td>
                                            </tr>
