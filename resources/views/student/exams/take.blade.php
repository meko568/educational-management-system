<x-app-layout>
                ...
                <div class="flex-1 overflow-y-auto p-4">
                    <div class="bg-white dark:bg-stone-800 overflow-hidden">
                        ...
                        <div class="border-t border-stone-200 dark:border-stone-700 p-4">
                            <button type="submit" form="exam-form" class="w-full inline-flex items-center justify-center px-4 py-3 bg-orange-600 border border-transparent rounded-xl font-bold text-sm text-white uppercase tracking-widest hover:bg-orange-700 transition-colors shadow-lg shadow-orange-600/20 mb-2">
                                Submit Exam
                            </button>
                ...
                <div class="flex-1">
                    <div class="bg-white dark:bg-stone-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <form id="exam-form" action="{{ route('student.exams.submit', $attempt->id) }}" method="POST">
                                @csrf
    ...
    <script>
        ...
        async function saveAnswer(questionId, choiceId, textAnswer) {
            ...
            try {
                const response = await fetch('{{ route('student.exams.save-answer', $attempt->id) }}', {
                    method: 'POST',
                    headers: {
        ...
        function saveState() {
            ...
            localStorage.setItem('examTakingState', JSON.stringify({
                answers,
        ...
        function loadState() {
            const saved = localStorage.getItem('examTakingState');
            if (!saved) return;
            ...
            try {
                ...
                if (state.attemptId !== {{ $attempt->id }}) {
                    localStorage.removeItem('examTakingState');
                    return;
                }
